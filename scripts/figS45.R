...
pdf("figs/fig4/com7_non_zeros.pdf", width = 5, height = 4)
...
my_heatmap(train_feature, sig_feature, sig_feature, "com7_heatmap")
...
pdf("figs/fig4/Com_7_auc.pdf", width = 4, height = 3)
