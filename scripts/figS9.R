...
for (genus in c(intersect_features, normal_crc_features, other_features)) {
    ...
    rstatix::add_xy_position(x = "Genus",  step.increase = 0.15)  

    write.csv(cared_data, paste0("figdata/figS9_", problem, ".csv"))

}


    pdf(paste0("figs/figS8/boxplot_", problem, ".pdf"), width = 6.5, height = 3)
